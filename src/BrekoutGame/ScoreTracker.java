...
public class ScoreTracker {
	...
	public void draw(Graphics2D graphics) {
		...
		if (ballsLeft > 0 && game.getState() != State.VICTORY) {
			...
			String score = String.valueOf(scoreCounter);
		...
		/* Ritar upp Game Over om spelaren har slut på bollar */
			...
			int textY = Const.GAMEAREA_HEIGHT /2 + 110 - textHeight + graphics.getFontMetrics().getAscent();
			...
			int textWidth2 = Const.GAMEAREA_WIDTH /2 - graphics.getFontMetrics().stringWidth("Your score: " + scoreCounter) / 2;
			int textWidth3 = Const.GAMEAREA_WIDTH /2 - graphics.getFontMetrics().stringWidth("Press 'space' to play again") /2;
			
			graphics.drawString("Your score: " + scoreCounter, textWidth2 , textY + 80);
	...
	/* Uppdaterar det aktuella resultatet,
	 * pre: anropas i update() från Game-instansen
	 * post: uppdaterar scoreCounter */
