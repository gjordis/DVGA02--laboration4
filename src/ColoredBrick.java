...
public class ColoredBrick extends Sprite {
	 ...
	 * egenskaper till klassen: "color, hp, hitScore, killScore & powerUp".
	 * Som används för unika egenskaper hos objekten.
	 */
	public ColoredBrick(int x, int y, int width, int height, Color color, int hp, int hitScore,int killScore, String powerUp) {
	...
	public void draw(Graphics2D graphics) {
		...
		/* Rundade hörn */
		//RoundRectangle2D roundedRect = new RoundRectangle2D.Double(getX(), getY(), getWidth(), getHeight(), 8, 8);
